const channelID = 'UCWB1TQHxLpuEp9hcKnUX1HA';
...
// const recentLWL2 = `https://www.googleapis.com/youtube/v3/playlistItems?key=${API_KEY}&playlistId=PLyXhNarRdOEy8Kz3VRgHsq6grb6jlE3Z6&part=snippet,id&order=date&maxResults=1`;
const recentLWL = `https://www.googleapis.com/youtube/v3/search?part=snippet&type=video&order=date&safeSearch=none&maxResults=1&channelId=${channelID}&key=${API_KEY}`
...
$.get(recentLWL, (data) => {
    // console.log(data);
    document.getElementById('latest-lwl').src=`https://www.youtube.com/embed/${data.items["0"].id.videoId}?rel=0&amp;&modestbranding=1&amp;color=white&amp;&listType=playlist&amp;list=PLyXhNarRdOEy8Kz3VRgHsq6grb6jlE3Z6`;
});
